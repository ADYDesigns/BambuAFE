...
# Bill of Materials
This is a list of materials that will be required.  These are my suggestions to have a successful project but if you are already experienced with electronics and microcontrollers you can of course change the items as you see fit.  <details>
  <summary>🔍 Click to expand/collapse image</summary>
  <br>
  <img src="images/Components.jpg" alt="Expanded view">
</details> 
