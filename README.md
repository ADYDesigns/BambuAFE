...
# Bill of Materials
This is a list of materials that will be required.  These are my suggestions to have a successful project but if you are already experienced with electronics and microcontrollers you can of course change the items as you see fit.  <details>![Overview Image of Components](images/Components.jpg)</details> 
